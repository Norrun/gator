...
const getFeedFollowsForUser = `-- name: GetFeedFollowsForUser :many
 SELECT users_feeds.id, users_feeds.created_at, users_feeds.updated_at, users_feeds.user_id, users_feeds.feed_id, feeds.name AS feed_name, users.name AS user_name FROM users_feeds
...
func (q *Queries) RemoveUserFollow(ctx context.Context, arg RemoveUserFollowParams) error {
	_, err := q.db.ExecContext(ctx, removeUserFollow, arg.UserID, arg.FeedID)
	return err
}
